...
//   void initState() {
//     super.initState();
//     // تحضير الكونترولرز بالبيانات الحالية
...
//     return BlocProvider(
//       create: (context) => getIt<AccountCubit>()..updateAccountInfo,
//       // (
...
class _EditAccountInfoScreenState extends State<EditAccountInfoScreen> {
  ...
  @override
  Widget build(BuildContext context) {
    // إزالة BlocProvider لأننا بنستخدم نفس الـ Cubit من الصفحة السابقة
    return Scaffold(
      appBar: AppBar(title: const Text("تعديل المعلومات")),
      body: BlocConsumer<AccountCubit, AccountState>(
        listener: (context, state) {
